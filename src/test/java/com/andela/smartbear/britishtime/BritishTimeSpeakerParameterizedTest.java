...
public class BritishTimeSpeakerParameterizedTest {
    ...
    void parameterizedCases(String input, String expected) {
        ...
        assertEquals(expected, speaker.speak(h, m));
    }

    @Test
    @DisplayName("Invalid minute throws")
    void invalidMinute() {
        assertThrows(IllegalArgumentException.class, () -> speaker.speak(10, 60));
        assertThrows(IllegalArgumentException.class, () -> speaker.speak(10, -1));
    }
